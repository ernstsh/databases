...
<div class = "megadiv" style = " padding: 0px 25px 0px 25px ">   
			 <div > 
					<center><img src = "images/logoLand3.png" width="1500" height="600" ></center>
			...
			<div class = "container">
				<div style = " padding: 60px 60px 0px 15px " style = "float: left;  margin-left: 60px; width: 60px; height: 60px; ">
				   ...
				   <p style = "font-size: 30px; width: 35em; border: 1px solid #FFFFFF; word-wrap: break-word;">
